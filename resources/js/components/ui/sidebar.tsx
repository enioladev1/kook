...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isMobile || state === "collapsed" ? <HugeiconsIcon icon={PanelLeftOpenIcon} /> : <HugeiconsIcon icon={PanelLeftCloseIcon} />}
